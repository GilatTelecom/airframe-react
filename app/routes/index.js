...
// ----------- Firewall ---------------
import FirewallRules from './Firewall/Rules/FirewallRules'
import FirewallAlias from './Firewall/Alias/firewallAlias';
...
export const RoutedContent = () => {
    return (
        <Switch>
            <Redirect from="/" to="/dashboards/system" exact />
            ...
            <PrivateRoute exact path="/dashboards/system" component={System} />
            ...
            <PrivateRoute path="/firewall/rules" exact component={FirewallRules} />
            <PrivateRoute path="/firewall/alias" exact component={FirewallAlias} />
            ...
            { /*    Pages Routes    */ }
            <PrivateRoute component={ ComingSoon } path="/pages/coming-soon" />
            <PrivateRoute component={ Confirmation } path="/pages/confirmation" />
            <PrivateRoute component={ Danger } path="/pages/danger" />
            <PrivateRoute component={ Error404 } path="/pages/error-404" />
            <PrivateRoute component={ ForgotPassword } path="/pages/forgot-password" />
            <PrivateRoute component={ LockScreen } path="/pages/lock-screen" />
            <Route component={ Login } path="/pages/login" />
            <PrivateRoute component={ Register } path="/pages/register" />
            <PrivateRoute component={ Success } path="/pages/success" />
            <PrivateRoute component={ Timeline } path="/pages/timeline" />
