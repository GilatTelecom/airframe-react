...
export class AdvancedTable extends React.Component {
    ...
    render() {
        const columnDefs = this.props.columns !== undefined ? this.props.columns : this.createColumnDefinitions();
        ...
        return (
            <ToolkitProvider
                ...
                data={ this.props.data !== undefined ? this.props.data : this.state.users }
                columns={ columnDefs }
                search
                exportCSV
            >
